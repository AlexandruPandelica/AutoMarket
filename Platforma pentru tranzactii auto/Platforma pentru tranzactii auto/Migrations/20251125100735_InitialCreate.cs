        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    An_Fabricatie = table.Column<int>(type: "integer", nullable: false),
                    Kilometraj = table.Column<int>(type: "integer", nullable: false),
                    Descriere = table.Column<string>(type: "text", nullable: false),
                    Data_Postarii = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Nr_Vizualizari = table.Column<int>(type: "integer", nullable: false),
                    Locatie = table.Column<string>(type: "text", nullable: false),
                    UserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Anunt", x => x.ID_Anunt);
                    table.ForeignKey(
                        name: "FK_Anunt_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Comentariu = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Text_Comentariu = table.Column<string>(type: "text", nullable: false),
                    Recenzie = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Commentarii", x => x.ID_Comentariu);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorite_Anunt_ID_Anunt",
                        column: x => x.ID_Anunt,
                        principalTable: "Anunt",
                        principalColumn: "ID_Anunt",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_ImagineMasina = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Cale_Imagine = table.Column<string>(type: "text", nullable: false),
                    ID_Anunt = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Imagine", x => x.ID_ImagineMasina);
                    table.ForeignKey(
                        name: "FK_Imagine_Anunt_ID_Anunt",
                        column: x => x.ID_Anunt,
                        principalTable: "Anunt",
                        principalColumn: "ID_Anunt",
                        onDelete: ReferentialAction.Cascade);
